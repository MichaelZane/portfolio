        ...
        <>
            ...
            <Wrap>
                ...
                <About>
                    ...
                    <div id="bWrap">
                        <i id="ikon"class="fas fa-power-off fa-3x"></i>
                        <Text >Reliable</Text> 
                        <p id="bio">Showing Up On Time, Doing What I Say, Delivering On Deadlines. </p> 
                    </div>
                    <div id="bWrap">
                        <i id="ikon" class="fas fa-upload fa-3x"></i>
                        <Text >Self-Starter</Text> 
                        <p id="bio">Taking Initiative, Hugely Motivated, Passion To Succeed. </p>
                    </div >
                    <div id="bWrap">
                        <i id="ikon" class="far fa-save fa-3x"></i>
                        <Text >Results Driven</Text> 
                        <p id="bio">Meeting Challenges Head-On, Taking Accountability, Passion For Excellence. </p>
                    </div>
                    <div id="bWrap">
                        <i id="ikon" class="fas fa-at fa-3x"></i>
